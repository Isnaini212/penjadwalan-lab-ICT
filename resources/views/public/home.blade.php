    ...
    <div class="min-h-screen">
        <header class="border-b border-slate-200">
            <div class="max-w-7xl mx-auto px-4 py-4 flex items-center justify-between">
                ...
                <a href="/login" class="px-4 py-2 rounded-lg bg-blue-700 text-white text-sm font-medium hover:bg-blue-900">
                    Login
                </a>
            </div>
        </header>
                    ...
                    <table class="w-full text-sm">
                        <thead class="bg-slate-50 text-slate-600">
                            <tr>
                                ...
                                <th class="px-5 py-3 text-left font-semibold">Lab</th>
                                <th class="px-5 py-3 text-left font-semibold">Mata Kuliah</th>
                                <th class="px-5 py-3 text-left font-semibold">SKS</th>
                        ...
                        <tbody class="divide-y divide-slate-200">
                            <tr class="hover:bg-slate-50">
                                <td class="px-5 py-4">Senin</td>
                                <td class="px-5 py-4">08:00 - 10:00</td>
                                <td class="px-5 py-4">Lab 1</td>
                                <td class="px-5 py-4 font-medium text-slate-900">Basis Data</td>
                                <td class="px-5 py-4">3</td>
                                <td class="px-5 py-4">Pak Budi</td>
                                <td class="px-5 py-4">Fitra</td>
                            </tr>

                            <tr class="hover:bg-slate-50">
                                <td class="px-5 py-4">Senin</td>
                                <td class="px-5 py-4">10:00 - 12:00</td>
                                <td class="px-5 py-4">Lab 2</td>
                                <td class="px-5 py-4 font-medium text-slate-900">Pemrograman Web</td>
                                <td class="px-5 py-4">3</td>
                                <td class="px-5 py-4">Bu Sari</td>
