   ...
   public function store(Request $request)
{
    ...
    public function update(Request $request, $id)
    {
        ...
        // Jangan izinkan edit jika status approved
        if ($booking->status === 'approved') {
            return back()->with('error', 'Gagal! Pengajuan yang sudah disetujui tidak dapat diubah.');
        }
        ...
        // Validasi kebutuhan lab Ormawa: standar maksimal 36 peserta per lab.
        $maksimalPesertaPerLab = 36;
        $minimalLab = (int) ceil($request->kapasitas / $maksimalPesertaPerLab);
        ...
        return back()->with('success', 'Pengajuan booking laboratorium berhasil diperbarui!');
    }
}
